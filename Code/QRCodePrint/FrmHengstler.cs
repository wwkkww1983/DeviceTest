...
namespace QRCodePrint
{
    public partial class FrmHengstler : FrmBase
    {
        ...
        const string characterSize_Large = "1B 21 12";  //字体(大)
        const string characterSize_Normal = "1b 21 12"; //字体(中)
        ...
        const string barcodecmd = "1D 6B 49 {0} 67"; //code128 n个长度(长度必须包括0x67) 0x67子集A


        const string barcodesetting2 = "1B F0 09 07 02 02 00 01 00 00 FF"; //二维码设置
        const string barcodecmd2 = "1B F0 0A {0}"; //二维码指令 N个长度
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            var newcmd = string.Format(barcodecmd, (code.Length + 1).ToString("X2"));
            data.AddRange(newcmd.HexToByte());
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            data.AddRange("欢迎到访地王大厦".ToGb2312());
            data.AddRange(line2.HexToByte());
            ...
            var newCmd = string.Format(barcodecmd2, code.Length.ToString("X2"));
            data.AddRange(newCmd.HexToByte());
